...
const myFirstArray = ["hello", 12, true]; // объявите переменную здесь
console.log(myFirstArray);

//Задание 2
//Создайте массив mySecondArray, заполните его любыми значениями. Выведите длину массива.
const mySecondArray = ["low", "small", 1, 2, 3]; // объявите переменную здесь
...
const myInformation = ["Катя", "01", "декабрь", "стрелец"];
...
let twoCountries = countries.shift();
...
const squaredNumbers = numbers.map((a) => a ** 2);
...
const filterEvenNumbers = numbers.filter((a) => a % 2 === 0);
...
const sortAndPrint = (...numbers) => numbers.sort((a, b) => a - b);
